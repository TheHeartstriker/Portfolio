        ...
        <div className="AboutContainer">
          <div className="AboutLegend" ref={Ball1}>
            ...
            <p>
              ...
              located in the contacts section and my live projects and known
              tech stacks in the skills section. Currently I am working on
              improving my current projects and skills. I also do graphics
              programming on the side I am sure you did not see the interest
          ...
          <div className="AboutPersonal" ref={Ball2}>
            ...
            <p>
              ...
              interests and skills in these areas. Although currently I am
          ...
          <div className="AboutStart" ref={Ball3}>
            ...
            <p>
              ...
              into programming when I was 16 with the simple goal of keeping my
              mind sharp... After awhile I got hooked. The idea of being able to
              create almost anything within the confines of a computer and share
              it is endlessly entertaining to me. I find creation and
              improvement in the realm of computer science to be very
              fulfilling.
            </p>
          </div>
        </div>

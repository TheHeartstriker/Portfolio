export const Header1 = "Where I am at and where to see my work";
export const MainText1 = `You can find my current work and projects on my GitHub which is
...
export const Header2 = "Who am I";
export const MainText2 = `Hello my name is kaden wildauer and I am a web developer,
...
export const Header3 = "How it started";
export const MainText3 = `I have always been interested in computers and technology I got into

...
export function WorkCard({
  ...
  return (
    <div className="port-work-item">
      <div className={`port-work-item-main ${reverse ? "reverse" : ""}`}>
        <div className="port-work-item-main-text">
          <h3>{header}</h3>
          <p>{para1}</p>
          <p>{para2}</p>
        </div>
        <div className="port-work-item-main-image">
          ...
          <button className="port-work-item-main-image-link">
            <a href={link} target="_blank" rel="noopener noreferrer" />
            <Arrow />
          </button>
          <div className="port-work-item-main-image-con">
              ...
              <span
                ...
                className={
                  currentMediaIndex === index
                    ? "port-work-item-main-image-con-span"
                    : ""
                }
              ></span>
            ))}
      ...
      <div className={`port-work-item-stats ${reverse ? "reverse" : ""}`}>
        <div
          className={`port-work-item-stats-con ${active === 1 ? "active" : ""}`}
        ...
        <div
          className={`port-work-item-stats-con ${active === 2 ? "active" : ""}`}
        ...
        <div
          className="port-work-item-stats-con-sq"
          onMouseEnter={() => onMouseEnter(3)}
        >
          {servicesArr.map((tag, index) => (
            <div
              className={`port-work-item-stats-con-sq-it ${active === 3 ? "active" : ""}`}
              key={index}
            >
              <div className="port-work-item-stats-con-sq-it-text">
                <h5>{tag}</h5>
                <h6>Services</h6>
              </div>
            </div>

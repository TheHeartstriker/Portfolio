...
export const mainRight = {
  item1: {
    ...
    details: `${project1.main.leftDetails[1].value} — ${project1.main.rightDetails.values[0]} — ${project1.main.rightDetails.values[1]}`,
    endPoint: "/portfolio/fgraphs",
  },
  item2: {
    imgSrc: project2.main.image,
    heading: project2.hero.heading,
    details: `${project2.main.leftDetails[1].value} — ${project2.main.rightDetails.values[0]} — ${project2.main.rightDetails.values[1]}`,
    endPoint: "/portfolio/matsuri",
  },
  item3: {
    imgSrc: project3.main.image,
    heading: project3.hero.heading,
    details: `${project3.main.leftDetails[1].value} — ${project3.main.rightDetails.values[0]} — ${project3.main.rightDetails.values[1]}`,

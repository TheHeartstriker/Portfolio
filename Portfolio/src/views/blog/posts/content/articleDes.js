...
export const desPolySVG = {
  ...
  slug: "/blog/poly-svg-background",
};

export const desFlowField = {
  title: "Flow Fields, painting with math",
  tags: ["Coding", "Visual", "Creative", "Systems"],
  date: { day: 26, month: 9, year: 2025 },
...
export const desBackendLookLike = {
  ...
  slug: "/blog/backend-look-like",
};

export const desHoverCards = {
  title: "Modern Card Hover Animations, Css and Javascript",
  tags: ["Web", "Coding", "Creative", "Visual"],
  date: { day: 3, month: 12, year: 2025 },
